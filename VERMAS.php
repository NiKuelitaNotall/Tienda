...
<div class="cart-panel" id="cart-panel">
  ...
  <section class="productos">
    <h2 class="section-title">Manos que inspiran corazones que disfrutan</h2>
    ...
    <div class="grid-productos">
      ...
      <div class="producto-card">
        <img src="manualidades/m1.webp" alt="Blusa tradicional">
      ...
      <!-- Producto 2 -->
      <div class="producto-card">
        <img src="ROPA/3545f07c-3437-439d-b206-23787b809923.jpg" alt="Vestido para niña">
        <h3>Tazas</h3>
      ...
      <!-- Producto 3 -->
      <div class="producto-card">
        <img src="alebrijes/A10.jpg" alt="Blusa tradicional">
        <h3>Servilleta</h3>
      ...
      <!-- Producto 4 -->
      <div class="producto-card">
        <img src="manualidades/m14.jpg" alt="Alebrije">
        <h3>Bolsa</h3>
...
<!-- Producto 6 -->
     <div class="producto-card">
        <img src="alebrijes/A7.jpg" alt="Blusa tradicional">
        <h3>Bolsa</h3>
        <p class="precio">$420 MXN</p>
        <p class="descripcion">Blusa artesanal con bordados florales.</p>
        <form action="carrito/agregar_carrito.php" method="POST">
      ...
      <!-- Producto 7 -->
      <div class="producto-card">
        <img src="manualidades/m5.j" alt="Blusa tradicional">
        <h3>Aretes</h3>
        <p class="precio">$420 MXN</p>
        <p class="descripcion">Blusa artesanal con bordados florales.</p>
        <form action="carrito/agregar_carrito.php" method="POST">
      ...
      <!-- Producto 11 -->
      <div class="producto-card">
        <img src="alebrijes/A3.webp" alt="Blusa tradicional">
        <h3>Servilletero</h3>
        <p class="precio">$420 MXN</p>
        <p class="descripcion">Blusa artesanal con bordados florales.</p>
        <form action="carrito/agregar_carrito.php" method="POST">
...
<!-- Producto 13 -->
      <div class="producto-card">
        <img src="ROPA/Beautifully Embroidered Dress, PLUS SIZE….jpg" alt="Blusa tradicional">
        <h3>Servilleta</h3>
        <p class="precio">$420 MXN</p>
        <p class="descripcion">Blusa artesanal con bordados florales.</p>
        <form action="carrito/agregar_carrito.php" method="POST">
      ...
      <!-- Producto 16 -->
      <div class="producto-card">
        <img src="alebrijes/A4.jfif" alt="Blusa tradicional">
        <h3>Aretes</h3>
        <p class="precio">$420 MXN</p>
        <p class="descripcion">Blusa artesanal con bordados florales.</p>
        <form action="carrito/agregar_carrito.php" method="POST">
